...
import { FacebookIcon, TwitterIcon, YouTubeIcon } from './shared/Icon'

const Footer = () => {
    return (
        <>
            <footer className="footer p-10 bg-accent text-secondary">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-accent text-secondary border-white">
